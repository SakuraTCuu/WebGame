        ...
        <div class="row">
          <div class="col-lg-8 post-list blog-post-list">
            <div class="single-post">
              <img class="img-fluid" src="static/assets/images/p1.jpg" alt="">
              <ul class="tags">
                <li><a href="#">Art, </a></li>
            ...
            <div class="single-post">
              <img class="img-fluid" src="static/assets/images/p2.jpg" alt="">
              <ul class="tags">
                <li><a href="#">Art, </a></li>
                <li><a href="#">Technology, </a></li>
                <li><a href="#">Fashion</a></li>
            ...
            <div class="single-post">
              <img class="img-fluid" src="static/assets/images/p3.jpg" alt="">
              <ul class="tags">
                <li><a href="#">Art, </a></li>
                <li><a href="#">Technology, </a></li>
                <li><a href="#">Fashion</a></li>
            ...
            <div class="single-post">
              <img class="img-fluid" src="static/assets/images/p4.jpg" alt="">
              <ul class="tags">
                <li><a href="#">Art, </a></li>
                <li><a href="#">Technology, </a></li>
                <li><a href="#">Fashion</a></li>
          ...
          <div class="col-lg-4 sidebar">
            ...
            <div class="single-widget protfolio-widget">
              <img src="static/assets/images/user2.jpg" alt="">
              ...
              <div class="blog-list ">
                <div class="single-recent-post d-flex flex-row">
                  <div class="recent-thumb">
                    <img class="img-fluid" src="static/assets/images/r1.jpg" alt="">
                  </div>
                ...
                <div class="single-recent-post d-flex flex-row">
                  <div class="recent-thumb">
                    <img class="img-fluid" src="static/assets/images/r2.jpg" alt="">
                  </div>
                  <div class="recent-details">
                    <a href="blog-single.html">
                      <h4>
                ...
                <div class="single-recent-post d-flex flex-row">
                  <div class="recent-thumb">
                    <img class="img-fluid" src="static/assets/images/r3.jpg" alt="">
                  </div>
                  <div class="recent-details">
                    <a href="blog-single.html">
                      <h4>
                ...
                <div class="single-recent-post d-flex flex-row">
                  <div class="recent-thumb">
                    <img class="img-fluid" src="static/assets/images/r4.jpg" alt="">
                  </div>
                  <div class="recent-details">
                    <a href="blog-single.html">
                      <h4>
